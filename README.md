...
A thoroughful analysis of this dataset, making use of different Python libraries, was performed in the attached Jypiter Notebook that can also be found [here](Singapore apartment resale prices analysis.ipynb). The following Python libraries were used for this project:
* pandas
* numpy
* matplotlib
* seaborn
